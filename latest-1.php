...
<body style="height: 100%;height: 100vh;margin: 0;">
    <div class="container-fluid" style="height: 100%;display: flex;flex-direction: column;">
        <div class="row fixheight">
            <div class="col-md-4 col-lg-3 col-xl-2 offset-lg-0 hideformob" style="padding-right: 0px;padding-left: 0px;">
                <div class="left-menu">
                    <div class="setborder darkbars" style="border-bottom: 0px solid rgba(0,0,0,0);">
                        <form>
                            <div class="form-group">
                                <p style="font-family: 'Titillium Web', sans-serif;font-size: 27px;color: rgb(96,96,96);margin-top: 22px;margin-left: 23px;margin-bottom: 0px;"><strong>Rooms</strong></p><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars" role="button"># kultur</a><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars" role="button"
                                    ...
                                    role="button" style="margin-top: 0px;"># uteseksjon</a><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars" role="button" style="margin-top: 0px;"># uteseksjon</a><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars"
                                    role="button" style="margin-top: 0px;"># uteseksjon</a><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars" role="button" style="margin-top: 0px;"># uteseksjon</a><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars"
                                    role="button" style="margin-top: 0px;"># uteseksjon</a><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars" role="button" style="margin-top: 0px;"># uteseksjon</a></div>
                        </form>
                    </div>
                    <div class="d-md-flex d-lg-flex d-xl-flex align-items-md-end align-items-lg-end align-items-xl-end setborder darkbars" style="border-top: 0px solid rgba(0,0,0,0);"><a class="btn btn-secondary btn-block text-left left-menu-btn setfont darkbars" role="button" style="margin-top: 0px;border-top: 1px solid #d6d6d6;color: rgb(33,37,41);" href="admin.php">Management</a></div>
                </div>
            </div>
                ...
                <div class="divwrap d-flex flex-column justify-content-between">
                    <div class="middle-top-div" style="padding: 23px;">
                        <form>
                            <div class="form-group" style="margin-bottom: 0px;">
                                <h1 style="font-family: 'Titillium Web', sans-serif;margin-bottom: 5px;font-size: 33px;color: rgb(96,96,96);"><strong>Støttefunksjonen</strong><label class="roomlabel" style="margin-bottom: 0px;"># støttefunksjonen</label></h1>
                    ...
                    <div>
                        <div class="middle-top-div" style="/*position: absolute;*//*bottom: 0;*//*width: 100%;*/padding: 15px;">
                            <form>
                                <div class="form-group" style="margin-bottom: 0px;"><textarea class="form-control textarea-replace messagebox textarea-autosize" id="msg" placeholder="Write something.." rows="1" maxlength="1500"></textarea><label id="lblcount" style="margin-bottom: 0px;font-size: 13px;color: rgb(133,133,133);margin-left: 12px;">0 / 1500</label></div>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-lg-2 col-xl-2 offset-lg-0 offset-xl-0 fixheight-right hideonresize" style="padding-left: 0px;padding-right: 0px;">
                <div class="right-menu setborder darkbars">
                    <p style="font-family: 'Titillium Web', sans-serif;font-size: 27px;color: rgb(96,96,96);"><strong>Members</strong></p>
                    <form>
                        <div class="form-group">
                            <div class="dropleft"><button class="btn dropdown-toggle memberitem" data-toggle="dropdown" aria-expanded="false" type="button">Kriss&nbsp;</button>
                                <div class="dropdown-menu" role="menu">
                                    <h6 class="dropdown-header" role="presentation">Options</h6><a class="dropdown-item" role="presentation" href="#">Visit profile</a><a class="dropdown-item" role="presentation" href="#">Send message</a>
                                    <div class="dropdown-divider" role="presentation"></div><a class="dropdown-item" role="presentation" href="#">Kick from room</a></div>
                            </div>
                            <div class="dropleft"><button class="btn dropdown-toggle memberitem" data-toggle="dropdown" aria-expanded="false" type="button">Ole</button>
                                <div class="dropdown-menu" role="menu">
                                    <h6 class="dropdown-header" role="presentation">Options</h6><a class="dropdown-item" role="presentation" href="#">Visit profile</a><a class="dropdown-item" role="presentation" href="#">Send message</a>
                                    <div class="dropdown-divider" role="presentation"></div><a class="dropdown-item" role="presentation" href="#">Kick from room</a></div>
                            </div>
                            <div class="dropleft"><button class="btn dropdown-toggle memberitem" data-toggle="dropdown" aria-expanded="false" type="button">Richard</button>
                                <div class="dropdown-menu" role="menu">
                                    <h6 class="dropdown-header" role="presentation">Options</h6><a class="dropdown-item" role="presentation" href="#">Visit profile</a><a class="dropdown-item" role="presentation" href="#">Send message</a>
                                    <div class="dropdown-divider" role="presentation"></div><a class="dropdown-item" role="presentation" href="#">Kick from room</a></div>
                            </div>
