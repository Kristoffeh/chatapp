...
if ($result = mysqli_query($conn, $query)) {
    ...
    ?>
        ...
        margin-bottom: 1px;"><?php echo $row['sentby']; ?></label>
        ...
        <p style="font-family: 'Titillium Web', sans-serif;font-size: 17px;margin-top: 10px;margin-left: 40px;"><?php echo $row['message']; ?><br /></p>
</div>
