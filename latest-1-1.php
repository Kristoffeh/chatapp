                        ...
                        <form>
                            <div class="form-group" style="margin-bottom: 0px;">
                                ...
                                <div class="dropdown"><button class="btn dropdown-toggle memberitem" data-toggle="dropdown" aria-expanded="false" type="button">Ole</button>
                                    <div class="dropdown-menu" role="menu" style="padding: 0px;"><a class="dropdown-item" role="presentation" href="#" style="padding-top: 2px;padding-bottom: 2px;">Visit profile</a><a class="dropdown-item" role="presentation" href="#" style="padding-top: 0px;padding-bottom: 0px;">Send message</a>
                                        <div
                                            class="dropdown-divider" role="presentation"></div><a class="dropdown-item" role="presentation" href="#" style="padding-top: 0px;padding-bottom: 5px;">Kick from room</a></div>
                            </div>
                    </div>
                    </form>
                </div>
